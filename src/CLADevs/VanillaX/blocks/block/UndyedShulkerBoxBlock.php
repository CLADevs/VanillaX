...
class UndyedShulkerBoxBlock extends Transparent{

    public function __construct(int $id = BlockIds::UNDYED_SHULKER_BOX, int $meta = 0, string $name = "Shulker Box", int $itemId = ItemIds::UNDYED_SHULKER_BOX){
